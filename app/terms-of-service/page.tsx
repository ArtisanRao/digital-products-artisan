...
export default function TermsOfServicePage() {
  ...
  return (
    <main className="container mx-auto px-4 py-10 prose prose-neutral dark:prose-invert max-w-3xl">
      ...
      <p>Your license depends on the product’s listing and the license file inside the download.</p>
      <ul>
        <li>
      ...
      <ul>
        ...
        <li>If a link expires or a file is corrupted, <Link href="/contact">contact us</Link> for a fresh link.</li>
      </ul>

      <h2 id="refunds">4. Refunds</h2>
      <p>
        Because digital content is irrevocably delivered, <strong>all sales are final</strong> except where required by law.
        We’ll repair/replace defective files reported within 14 days.
      </p>

      <h3 id="eu-withdrawal">4.1 EU Right of Withdrawal (Digital Content)</h3>
      <p>
        EU consumers normally have a 14-day right of withdrawal. For digital content not supplied on a tangible medium,
        this right ends once delivery begins with your <em>express consent</em> and acknowledgement that you lose the right
        of withdrawal. By accessing or downloading the files immediately after purchase, you agree to this early delivery
        and waive the withdrawal right for that order.
      </p>
      ...
      <p>
        Where applicable, VAT/sales tax is calculated at checkout based on your location and prevailing regulations
        (including EU VAT rules). Invoices/receipts reflect any tax collected.
      </p>

      <h2 id="prohibited">7. Prohibited Uses</h2>
      <ul>
        <li>Re-uploading, sharing, or reselling source files unless the license explicitly grants PLR/MRR rights.</li>
      ...
      <p>
        Unless transferred under a PLR/MRR license, all intellectual property remains with Digital Products Artisan or licensors.
      ...
      <p>
        If you believe content infringes your rights, please provide notice including your contact details, identification of the
        work claimed to be infringed, the location (URL) of the material, and a good-faith statement. We will review promptly.
      </p>

      <h2 id="liability">10. Warranties &amp; Liability</h2>
      <p>
        Products are provided “as is” without warranties beyond those required by law. To the maximum extent permitted,
        we are not liable for indirect or consequential damages arising from use of our products.
      </p>

      <h2 id="law">11. Governing Law</h2>
      <p>
        These terms are governed by the laws of Germany. If you are an EU consumer, mandatory consumer protection rules
        of your country of residence also apply.
      </p>

      <h2 id="changes">12. Changes to These Terms</h2>
      <p>
        We may update these terms from time to time. The “Last updated” date above indicates the latest version.
      </p>

      <h2 id="contact">13. Contact</h2>
      <p>
        Need help? <Link href="/contact">Contact us</Link>. We aim to respond within 1–2 business days.
      </p>

      <hr />
      <p className="text-sm">
        <strong>Checkout notice:</strong> “By completing this purchase, you request immediate delivery of digital content and
        acknowledge that your 14-day right of withdrawal ends once the download or access begins.”
      </p>
    </main>
  );
}
