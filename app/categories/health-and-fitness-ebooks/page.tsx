...
export default function HealthAndFitnessEbooksPage() {
  const ebooks = [
    {
  ...
  const structuredData = ebooks.map((ebook) => ({
    ...
    offers: {
      "@type": "Offer",
      url: `https://digitalproductsartisan.com/categories/health-and-fitness-ebooks`,
      priceCurrency: "EUR",
  ...
  return (
    <>
      <Head>
        <title>Health & Fitness eBooks | Digital Products Artisan</title>
        <meta
          name="description"
          content="Browse premium downloadable eBooks across genres — self-help, productivity, fiction, and more."
        />
        <script
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-10">💪 Health & Fitness eBooks</h1>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <ShopActions
                    ...
                    // If your checkout expects numeric product IDs only, consider:
                    // buyEnabled={false}
                  />
                </div>
              </div>
