...
export default function DigitalArtPage() {
  const items: Item[] = [
    { slug: 'digital-art', title: 'Digital Art Starter Pack', price: 6.99, description: 'Print-ready digital artworks.' },
    { slug: 'fantasy-concept-art-collection', title: 'Fantasy Concept Art', price: 7.99, description: 'Rich, imaginative scenes.' },
    { slug: 'monochrome-mood-collection', title: 'Monochrome Mood Collection', price: 5.99, description: 'Minimal, striking pieces.' },
  ];
  return (
