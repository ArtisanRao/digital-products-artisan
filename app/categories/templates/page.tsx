...
export default function TemplatesPage() {
  const items: Item[] = [
    { slug: 'invoice-template', title: 'Invoice Template Kit', price: 5.49, description: 'Clean, professional invoices.' },
    { slug: 'presentation-deck-template', title: 'Presentation Deck Template', price: 6.49, description: 'Modern slide layouts for anything.' },
    { slug: 'resume-template', title: 'Ultimate Resume Template', price: 6.99, description: 'ATS-friendly resume with cover letter.' },
  ];
