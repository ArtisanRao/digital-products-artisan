...
const PRODUCTS: Record<string, { title: string; price: number; images: string[]; description: string }> = {
  "1": {
    ...
    description: "Complete, rights-included digital shop bundle. Rebrand and resell ebooks, courses, prompts, templates, and more.",
  },
};
...
export default function ProductPage() {
  ...
  const cover = p.images[0] ?? "/images/placeholder-cover.jpg";
    ...
    >
      ...
      <section className="relative z-[60] pointer-events-auto isolate">
        ...
        <div className="relative z-[61] mt-6 flex flex-wrap gap-3 pointer-events-auto">
          ...
          <ShopActions
            item={{ id, title: p.title, price: p.price, image: cover, description: p.description }}
