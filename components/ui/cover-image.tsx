...
const ratioClassMap: Record<NonNullable<CoverImageProps["ratio"]>, string> = {
  "16/9": "aspect-[16/9]",
  "3/2": "aspect-[3/2]",
  "4/3": "aspect-[4/3]",
  "1/1": "aspect-square",
...
export default function CoverImage({
  ...
  const ratioClass = ratioClassMap[ratio] ?? ratioClassMap["3/2"];
  ...
  return (
    ...
    >
      <Image
        ...
        priority={priority}
        draggable={false}
        className={[fitClass, "transition-transform duration-300 group-hover:scale-[1.02]"].join(" ")}
      />
