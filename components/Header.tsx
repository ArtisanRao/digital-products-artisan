...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm shadow-sm border-b border-blue-100 m-0 p-0 overflow-x-hidden">
      <div className="container mx-auto px-4 !py-0 m-0 max-w-full">
        <div className="flex flex-wrap items-center justify-between h-16 m-0 p-0 gap-2">
          {/* Logo */}
          <Logo size="md" className="mr-4 flex-shrink-0" />

          {/* Navigation links: always visible */}
          <nav className="flex flex-wrap items-center space-x-4 flex-grow min-w-0 overflow-visible max-w-[calc(100%-100px)]">
            <Link href="/products" className="nav-link whitespace-nowrap text-sm sm:text-base">Products</Link>
            <Link href="/categories" className="nav-link whitespace-nowrap text-sm sm:text-base">Categories</Link>
            <Link href="/about" className="nav-link whitespace-nowrap text-sm sm:text-base">About</Link>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  ...
                  className="nav-link inline-flex items-center space-x-1 whitespace-nowrap text-sm sm:text-base"
                >
                  <span>Support</span>
            ...
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent className="border-blue-200">
                  ...
                  <DropdownMenuItem asChild><Link href="/orders">My Orders</DropdownMenuItem>
          ...
          <Button
            variant="ghost"
            size="sm"
            className="md:hidden hover:bg-blue-50 flex-shrink-0"
